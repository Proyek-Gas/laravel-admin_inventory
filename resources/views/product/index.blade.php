      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-12">
                   <form action="{{route('products.addOrderUser')}}" method="post">
                        @csrf
                        <div class="center">
...
<script>
    ...
    function productDetails(product, imagedata) {
        ...
        //masukkan max di input sesuai dengan jumlah barang
        $("#inputNumber").attr('max',product[17]);

        $("#id_product").val(product[12]);
